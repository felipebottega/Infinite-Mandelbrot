...
func _ready() -> void:
	var a = float2array(12.34)
	var b = float2array(0.56)

	print("=== CUSTOM REPRESENTATION ===")
	print(float_repr_add(a, b))
	print(float_repr_sub(a, b))
	print(float_repr_mul(a, b))
	print(float_repr_div(a, b, 22))
...
func float_repr_div(a: Array, b: Array, precision: int = 12) -> Array:
	...
	var quotient: Array[int] = divres["quotient"]
